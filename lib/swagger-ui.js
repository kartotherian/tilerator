...
const HTTPError = require('../lib/util.js').HTTPError; // eslint-disable-line prefer-destructuring


// Swagger-ui helpfully exporting the absolute path of its dist directory
const docRoot = `${require('swagger-ui').dist}/`; // eslint-disable-line global-require
